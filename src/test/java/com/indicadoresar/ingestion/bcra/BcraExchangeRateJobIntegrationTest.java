...
class BcraExchangeRateJobIntegrationTest extends PostgresContainerSupport {
    ...
    void jobInsertsValueAndIsIdempotentOnSecondRun() throws Exception {
        ...
        assertThat(findValueForDate(date)).isEqualByComparingTo(new BigDecimal("1210.7500"));
        ...
        assertThat(indicatorValueRepository.count()).isEqualTo(1);
        assertThat(findValueForDate(date)).isEqualByComparingTo(new BigDecimal("1220.0000"));
    }
